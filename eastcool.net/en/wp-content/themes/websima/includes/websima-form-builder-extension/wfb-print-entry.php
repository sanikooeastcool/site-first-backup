                                ...
                                if ($pid) {
                                    if (get_post_type(esc_attr($pid)) == 'af_form') {
                                        ...
                                        if (!empty($field_groups)) {
                                            if ($form['title']) {
                                                echo '<h1 class="form-title">' . esc_html($form['title']) . '</h1>';
                                            }
                                            foreach ($field_groups as $field_group) {
                                                echo '<div class="form-items-wrapper">';
                                                if ($field_group['title']) {
                                                    echo '<h2 class="form-subtitle">' . esc_html($field_group['title']) . '</h2>';
                                                }
                                            ...
                                            echo '<div class="alert-error">An error has occurred</div>';
                                        }
                                    } else {
                                        echo '<div class="alert-error">An error has occurred</div>';
                                    }
