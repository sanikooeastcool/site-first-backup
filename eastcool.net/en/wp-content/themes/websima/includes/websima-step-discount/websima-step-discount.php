...
function websima_step_discount_init()
{
    if (function_exists('acf_add_options_page')) {
        acf_add_options_sub_page(array(
            'page_title' => 'Step-by-step discount',
            'menu_title' => 'Step-by-step discount',
...
function websima_sd_add_row()
{
    ...
    if ($sd_global_discount) :
        echo '<tr class="cart-total-volume"><th>off<br><span>(Top orders ' . wc_price($sd_global_active_discount['sd_min_price']) . ')</span></th><td>' . '-' . wc_price($sd_global_discount) . '</td></tr>';
    endif;
}
/********* add meta **********/
...
{
    $label = __('step discount', 'woocommerce');
