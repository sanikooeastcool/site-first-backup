jQuery(document).ready(function ($) {
    ...
    var loading_text = 'Checking information ...';
    var user_mobile_required = 'Please enter your mobile number';
    var user_mobile_validation = 'The entered mobile number is not valid';
    var user_verification_code_required = 'Please enter your verification code';
    var user_verification_code_digits = 'The verification code must be numeric';
    var user_verification_code_length = 'The length of the verification code must be 6 digits';
    var user_password_required = 'Please enter your password';
    var user_password_digits = 'Password must be numeric';
    var user_password_length = 'Password length must be 6 digits';
    ...
    jQuery('.resend_code_wrapper').on('click', '.resend-code:not(.disable)', function () {
        ...
        if (type == 'otp-password') { var again_text = 'Resend password'; }
        if (type == 'reset-password') { var again_text = 'Resend password'; }
        if (type == 'verification-code') { var again_text = 'Resend verification code'; }
        ...
        setTimeout(function () {
            ...
            var x = setInterval(function () {
                ...
                if (distance < 0) {
                    ...
                    jQuery(element).text(distance + ' sec');
                }
            }, 1000);
        }, 2000);
    };
