...
var mobile_required = 'Please enter your mobile number';
var mobile_validation = 'The entered mobile number is not valid';
var added_notify_msg = 'Cancel product inventory notification';
var removed_notify_msg = 'Product inventory information';
...
(function ($) {
    $(document).ready(function () {
        ...
        $("#menumobile .sub-menu").prepend("<div class='title-sub-head'><span class='sub-closer float-left'><i></i></span><strong class='float-right title-subcome'>return</strong></div>");
        ...
        function counter() {
            jQuery(".section-products-offer .product-item-parent").each(function () {
                ...
                if (exptime != null) {
                    ...
                    if (distance < 0) {
                        jQuery(this).find('.countdown').addClass('col').html("<span class='expire-title'>Finished</span>");
    ...
    function counter() {
        jQuery(".section-banners .banner-wrap").each(function () {
            ...
            if (exptime != null) {
                ...
                if (distance < 0) {
                    jQuery(this).find('.countdown').html("<span class='expire-title'>Time Expired</span>");
                    jQuery(this).addClass("item-offer-finish");
                }
            }
        });
