...
<footer id="footer" <?php if($bg){?>style="background-image:url(<?php echo wp_get_attachment_image_url($bg,'full');?>)"<?php } ?>>
    <div class="container">
        ...
        <div class="row footer-end mt-4 mb-2">
            <div class="mx-auto col-sm-8 col-md-3 ">
            ...
            <div class=" col-md-6 call-footer">
                <?php if (have_rows('phone_ft', 'option')): ?>
                    <?php while (have_rows('phone_ft', 'option')) : the_row(); ?>
                        <a class="about-call" href="tel:<?php echo str_replace('-', '',get_sub_field('phone_num','option')); ?>" rel="nofollow"><span class="call_text"> <?php echo get_sub_field('phone_title','option'); ?></span><span><?php echo get_sub_field('phone_num','option'); ?></span></a>
                    <?php endwhile; ?>
                <?php endif; ?>
