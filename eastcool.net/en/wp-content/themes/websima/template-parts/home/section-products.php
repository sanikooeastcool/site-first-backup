...
$bg = get_sub_field('image');
 ?>
<section class="section-products-home section-base fadeInDown wow" data-wow-delay="0.5s" <?php if($bg){?>style="background-image:url(<?php echo wp_get_attachment_image_url($bg,'full');?>)"<?php } ?>>
    <div class="container">
