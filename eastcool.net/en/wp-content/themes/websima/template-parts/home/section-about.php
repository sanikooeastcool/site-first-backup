...
<section class="section-about">
    <div class="container">
        <div class="row align-items-center">
            <div class="<?php echo $cls; ?> order-lg-1 order-2 slideInRight wow" data-wow-delay="0.5s">
            ...
            <?php if(get_sub_field('image')){?>
                <div class="col-12 col-md-10 col-lg-5 mx-auto order-1 order-lg-2 slideInLeft wow" data-wow-delay="0.5s">
