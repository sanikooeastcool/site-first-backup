...
export default compose( [
	...
	withSelect( ( select, props ) => ( {
		isSaving: select( 'ithemes-security/dashboard' ).isSavingDashboard(
			props.dashboardId
		),
	...
	withPropChangeCallback(
		'isSaving',
		( prevIsSaving, { close, setState } ) =>
			prevIsSaving && ( setState( { shares: [] } ), close() )
	),
] )( ShareAdd );
