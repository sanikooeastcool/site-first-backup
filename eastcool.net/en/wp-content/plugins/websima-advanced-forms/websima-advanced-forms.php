...
class AF {
	...
	function load_plugin() {
		...
		include( $this->path . 'admin/websima-functions.php' );
		include( $this->path . 'fields/websima-acf-custom-fields-init.php' );
		...
		$this->classes['admin_notifications'] = include( $this->path . 'admin/admin-notifications.php' );
