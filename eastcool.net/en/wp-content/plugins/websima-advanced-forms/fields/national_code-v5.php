...
if( !class_exists('wfb_acf_field_national_code') ) :


class wfb_acf_field_national_code extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('National code', 'advanced-forms');
		...
		*  var message = acf._e('national_code', 'error');
		*/
...
// initialize
new wfb_acf_field_national_code( $this->settings );
