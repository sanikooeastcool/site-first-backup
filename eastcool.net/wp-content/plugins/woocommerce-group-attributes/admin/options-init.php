<?php
    ...
    $args = array(
        ...
        'use_cdn' => TRUE,
        'dev_mode' => FALSE,
        'display_name' => 'گروه‌بندی ویژگی‌های ووکامرس',
        'display_version' => '1.7.2',
        'page_title' => 'گروه‌بندی ویژگی‌های ووکامرس',
        'update_notice' => TRUE,
        'intro_text' => '',
        'footer_text' => '&copy; '.date('Y').' weLaunch',
        'admin_bar' => TRUE,
        'menu_type' => 'submenu',
        'menu_title' => 'گروه‌بندی ویژگی‌ها',
        'allow_sub_menu' => TRUE,
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'layout4Columns',
                'type'     => 'spinner',
                'title'    => __( 'ستون‌ها', 'wordpress-store-locator' ),
                'subtitle'     => __( 'تعداد ستون‌ها برای نمایش ویژگی‌ها در طرح شماره ۴.'),
                'min'      => '1',
                'step'     => '1',
                'max'      => '12',
                'default'  => '3',
