...
if( !class_exists('wfb_acf_field_phone') ) :


class wfb_acf_field_phone extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Phone', 'advanced-forms');
		...
		*  var message = acf._e('phone', 'error');
		*/
...
// initialize
new wfb_acf_field_phone( $this->settings );
