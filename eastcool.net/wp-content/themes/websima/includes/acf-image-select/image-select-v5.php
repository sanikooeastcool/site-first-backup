...
class acf_field_image_select extends acf_field
{
	...
	*/
	...
	{
		// scripts
		wp_register_script('acf-input-image-select', get_template_directory_uri().'/includes/acf-image-select/js/image-select.js', array('acf-input'), $this->settings['version']);
		wp_enqueue_script(array(
			'acf-input-image-select',
		));
		
		// styles
		wp_register_style('acf-input-image-select', get_template_directory_uri().'/includes/acf-image-select/css/image-select.css', array('acf-input'), $this->settings['version']);
