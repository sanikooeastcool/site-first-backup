...
function websima_wc_wishlist(){
    ...
    if ($my_posts->have_posts()) :
        ...
        echo "<div class='woocommerce-error'>شما محصولی در لیست علاقه مندی ها ندارید.</div>";
    endif;
}
...
function websima_wc_wishlist_account_menu_items( $menu_links ){
        $menu_links = array_slice($menu_links, 0, 2, true)
            + array('wishlist' => 'لیست علاقه مندی')
...
function websima_wc_wishlist_add_templates( $post_templates, $wp_theme, $post, $post_type ) {
    $post_templates['includes/websima-wishlist/wishlist.php'] = 'علاقه مندی ها';
