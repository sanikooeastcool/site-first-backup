...
class AF_Admin_Entries {
	...
	function add_custom_columns( $columns ) {
		...
		$new_columns = array(
			...
			'status' => __( 'Status', 'advanced-forms' ),
			'print' => __( 'Print', 'advanced-forms' ),
		);
	...
	function custom_columns_content( $column, $post_id ) {
		...
		if ( 'form' == $column ) {
            ...
            echo wfb_entry_status_translator(esc_attr($status));
        }elseif('print' == $column){
            echo '<a href="'.esc_url(wfb_find_page_id('includes/websima-form-builder-extension/wfb-print-entry.php')).'?entry_id='.esc_attr($post_id).'" target="_blank">'.__( 'Print', 'advanced-forms' ).'</a>';
        }
	}
