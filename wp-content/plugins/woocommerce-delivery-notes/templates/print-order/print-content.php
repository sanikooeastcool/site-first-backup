	...
	?>
        ...
        echo '<div class="company-info box">';
            if($company_name or $company_phone or $company_fax){
                echo '<div class="row">';
                    if($company_name){ echo '<div class="column column-custom list-item"><span class="title">نام فروشنده/شرکت:</span><span class="value">'.esc_html($company_name).'</span></div>'; }
            ...
            if($company_nid or $company_rid or $company_eid){
                echo '<div class="row">';
                    if($company_nid){ echo '<div class="column column-custom list-item"><span class="title">شناسه ملی:</span><span class="value">'.esc_html($company_nid).'</span></div>'; }
		...
		<div class="billing-address address-box">
			...
			<address>
				...
				if ( ! $order->get_formatted_billing_address() ) {
					...
					$date_of_birth = get_post_meta(esc_attr($order_id) ,'date_of_birth', true);
                    $phone_number = get_post_meta(esc_attr($order_id) ,'phone_number', true);
					...
					echo '<div class="row">';
						...
						echo '</div>';
						echo '<div class="column column-4 list-item">';
							echo '<span class="title">تلفن ثابت:</span>';
					...
					if($customer_type == 'haghighi'){
						echo '<div class="row">';									
							echo '<div class="column column-4 list-item list-item">';
								echo '<span class="title">کد ملی:</span>';
								echo '<span class="value">'.esc_html($national_code).'</span>';
							echo '</div>';
							echo '<div class="column column-4 list-item list-item">';
								echo '<span class="title">تاریخ تولد:</span>';
...
<script>
    ...
    $("li:contains('فاکتور')").css('opacity', '1');
});
</script>
