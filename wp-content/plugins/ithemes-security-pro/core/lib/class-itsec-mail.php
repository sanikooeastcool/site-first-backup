	...
	public function add_footer() {
		...
		if ( ! ITSEC_Core::is_pro() ) {
			...
			$replacements = array(
				...
				'why_pro'    => sprintf( wp_kses( __( 'Why go Pro? <a href="%s">Check out the Free/Pro comparison chart.</a>', 'it-l10n-ithemes-security-pro' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'https://ithemes.com/security/?utm_source=email&utm_medium=notification&utm_campaign=itsecfreecta/' ) ),
			);
		...
		$replacements = array(
			...
			'documentation_content'  => sprintf( wp_kses( __( 'Read iThemes Security documentation and Frequently Asked Questions on <a href="%s">the Codex</a>.', 'it-l10n-ithemes-security-pro' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'https://help.ithemes.com/hc/en-us/categories/200147050' ) ),
