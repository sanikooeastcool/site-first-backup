...
class ITSEC_Core_Admin {
	...
	public function add_plugin_meta_links( $meta ) {
		...
		$meta[] = '<a href="https://ithemes.com/security/?utm_source=pluginspage&utm_medium=link&utm_campaign=itsecfreecta" target="_blank" rel="noopener noreferrer">' . __( 'Get Support', 'it-l10n-ithemes-security-pro' ) . '</a>';
