...
if($add_new_image == ''){ $add_new_image = get_template_directory_uri().'/includes/websima-compare/assets/images/add-new.jpg'; }
                ...
                echo '<div class="compare-box-wrapper" data-href="'.get_the_permalink().'">';
                        ...
                        echo '<div class="compare-share">';
                            echo '<div class="row align-items-center">';
                                echo '<div class="col-12 col-md-9">';
                                    echo '<span class="share-title">اشتراک گذاری</span>';
                                    echo '<small class="share-sub-title">می توانید از طریق شبکه های اجتماعی لیست مقایسه خود را با دوستانتان به اشتراک گذارید</small>';
                                echo '</div>';
                    ...
                    if($compare_list_count < 2) {
                        ...
                        echo '<div class="compare-summary">';
                            echo '<div class="compare-image image-empty">';
                        echo '<a href="'.get_permalink( wc_get_page_id( 'shop' ) ).'">';
                                echo '<img src="'.esc_url($add_new_image).'"  alt="add new" />';
                        echo '</a>';
                            echo '</div>';

                            echo '<h2 class="compare-title"><a>افزودن محصول جدید</a></h2>';

                            echo '<div class="compare-back-btn">';
                                echo '<a href="'.get_permalink( wc_get_page_id( 'shop' ) ).'">';
                                    echo 'بازگشت به فروشگاه';
                                echo '</a>';
                            echo '</div>';
                        echo '</div>';
                    echo '</div>';
                        echo '<div class="compare-empty"><i class="icon"></i>برای مشاهده لیست مقایسه باید بیش از یک محصول انتخاب کنید.</div>';
                    } else {
                                            ...
                                            if ( $i <= 5 ) {
                                                echo '<div class="compare-item" data-id="'.get_the_id().'">';
                                                    echo '<div class="compare-summary">';
                                                        ...
                                                        if($price != ''){ $final_price = $price; }else{ $final_price = '-'; }
                                                        if($product->is_in_stock()){
                                                            $final_stock =  '<span class="in-stock">موجود</span>';
                                                        }elseif(!$product->is_in_stock()){
                                                            $final_stock = '<span class="out-of-stock">ناموجود</span>';
                                                        }
                                                        echo '<ul class="list">';
                                                        ...
                                                        echo '<div class="compare-actions">';
                                                            echo '<div class="compare-similar-wrap">';
                                                                ...
                                                                echo '</div>';
                                                                echo '<span class="title">نمایش جزئیات مشابه </span>';
                                                            echo '</div>';
