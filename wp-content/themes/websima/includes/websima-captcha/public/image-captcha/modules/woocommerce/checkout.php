	...
	public function c4wp_validation_check( ) {
		...
		if ( ! empty( $_POST ) ) {
			...
			if ( $this->c4wp_plugin_options['c4wp_options']['captcha_enable_for'] == 'mathematical_captcha' ) {
				...
				} else if ( strtolower($_POST['c4wp_user_input_captcha']) != WP_CAPTCHA()->c4wp_object->c4wp_captcha_decode( $_POST['c4wp_random_input_captcha'] ) ) {
				...
				} else if ( strtolower($_POST['c4wp_user_input_captcha']) != $_POST['c4wp_random_input_captcha'] ) {
