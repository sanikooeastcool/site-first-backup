...
$rocket_cookie_hash = '3b6314cd66fe3892f85fd6ca2cc18275';
$rocket_logged_in_cookie = 'wordpress_logged_in_3b6314cd66fe3892f85fd6ca2cc18275';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_reject_uri = '/public_html(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/checkout/(.*)|/cart/|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$))';
