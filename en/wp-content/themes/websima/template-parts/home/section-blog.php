<section class="section-blog section-base">
    <div class="container">
        ...
        <div class="blog-carousel owl-carousel fadeInDown wow" data-wow-delay="0.5s">
            <?php
            $args      = array(
                'post_type'      => 'post',
        ...
        <div class="btn-wrap fadeInDown wow" data-wow-delay="0.75s"> <?php if (get_sub_field('btn_url') != '') echo "<a class='button button1' href=".get_sub_field('btn_url')." target='_blank'>".get_sub_field('btn')."</a>"; ?></div>
