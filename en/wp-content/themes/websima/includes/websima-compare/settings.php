...
class WC_Settings_Tab_compare
{
    ...
    {
        $settings_tabs['settings_tab_compare'] = 'compare';
    ...
    public static function get_settings()
    {
        ...
        $settings = array(
            ...
            'compare_unique_id' => array(
                'name' => 'brand name',
                'type' => 'text',
                'desc' => 'Enter your brand name in English without spaces. (This name is used to store comparison information)',
                'id'   => 'compare_unique_id'
            ),
            'compare_add_new_image' => array(
                'name' => 'add new image',
                'type' => 'url',
                'desc' => 'Enter the "Add New Product" image link.',
                'id'   => 'compare_add_new_image'
            ),
            'compare_tooltip_in' => array(
                'name' => 'tooltip for selected products',
                'type' => 'text',
                'desc' => 'The tooltip text for the products selected for comparison.',
                'id'   => 'compare_tooltip_in'
            ),
            'compare_tooltip_out' => array(
                'name' => 'tooltip for unselected products',
                'type' => 'text',
                'desc' => 'Tooltip text for unselected products.',
