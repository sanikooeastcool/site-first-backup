...
if( !class_exists('wfb_acf_field_mobile') ) :


class wfb_acf_field_mobile extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Mobile', 'advanced-forms');
		...
		*  var message = acf._e('mobile', 'error');
		*/
...
// initialize
new wfb_acf_field_mobile( $this->settings );
