...
$rocket_cookie_hash = 'cf2bfab0e037bc9579f45d009a39fbd3';
$rocket_logged_in_cookie = 'wordpress_logged_in_cf2bfab0e037bc9579f45d009a39fbd3';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '62b176d5cb025705521031';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/en(/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/en/checkout/(.*)|/en/cart/|/en/my-account/(.*)|/en/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$))';
